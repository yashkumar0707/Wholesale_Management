...
<body>
    ...
    <?php }
      ...
      <?php
            ...
            $conn1 = mysqli_connect("localhost","root","","test_wms");

            // $sql1 = "INSERT INTO payment (Mode,Amount_Paid,TransactionID,Transaction_Date)
            // VALUES('cash','100','49','2016')";
            //$sql1="INSERT INTO payment(TransactionID,Amount_Paid, Mode, Transaction_Date) VALUES('30', '4000','cash','2016')";
            //$sql1="INSERT INTO payment(TransactionID,Amount_Paid, Mode, Transaction_Date) VALUES('".$_SESSION['TransID']."', '$amtpaid','$mode','".$_SESSION['TID']."')";
            $sql1="INSERT INTO payment(TransactionID,Amount_Paid, Mode, Transaction_Date) VALUES('".$_SESSION['TransID']."', '$amtpaid','$mode',2016)";
            $result2 = mysqli_query($conn1,$sql1);
       ...
       ?>
        ...
        <?php } ?>
			...
			<footer class="clear">
				<p>&copy; WholeSale Business Managment </p>
			</footer>
